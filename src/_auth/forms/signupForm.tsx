...
const SignUpForm = () => {
  ...
  return (
    <Form {...form}>
      ...
      <p className="text-small-regular text-light-2 text-center mt-2">Already have an account? <Link to="/sign-in" className="text-primary-500 text-small-semibold ml-1 hover:underline">Log in</Link></p>
    </Form>
  );
};
